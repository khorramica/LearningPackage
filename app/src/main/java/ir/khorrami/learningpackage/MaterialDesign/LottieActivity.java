package ir.khorrami.learningpackage.MaterialDesign;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        thumb_up.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(LottieActivity.this, "Cheers!!", Toast.LENGTH_SHORT).show();
                //---- Your code here------
            }
        });
        ...
        thumb_down.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(LottieActivity.this, "Boo!!", Toast.LENGTH_SHORT).show();
                //---- Your code here------
            }
        });
