package ir.khorrami.learningpackage.Prpgressbar.widgets;
...
/**
 * Created by khorrami on ۳۱/۰۷/۲۰۲۲
 */
public class SlideToUnlock extends RelativeLayout {
    ...
    public SlideToUnlock(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        label =  findViewById(R.id.slider_label);
        seekbar = findViewById(R.id.slider_seekbar);
